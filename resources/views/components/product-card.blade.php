<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ">
    ...
    <div class="block2">
        ...
        <div class="block2-pic hov-img0 label-new" data-label="New">
            ...
            <a href="#product_card{{ $product->id }}" type="button" data-toggle="modal"
                data-target="#product_card{{ $product->id }}" data-id="{{ $product->id }}"
...
{{-- modal 1 --}}
{{-- <div class="modal fade" id="product_card" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<div class="wrap-modal1 js-modal1 p-t-60 p-b-20 " id="product_card{{ $product->id }}">
