<x-front-layout>
                ...
                <div class="col-lg-8">
                    <div class="checkout-steps-form-style-1">
                        <ul id="accordionExample">
                            <li>
                                <a class="btn btn-primary" href="#" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Your Personal Details </a>
                                <section class="checkout-steps-form-content collapse" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionExample" style="">
                                    <div class="row">
                                        <div class="col-md-12">
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ route('checkout') }}" class="needs-validation was-validated" novalidate="" method="POST">
                @csrf
                @method('post')
                <div class="row">
                ...
                {{-- <div>
                    ...
                    <div class="d-block my-3">
                        <div class="custom-control custom-radio">
                            <input name="paymentMethod" type="radio" checked="" required="">
