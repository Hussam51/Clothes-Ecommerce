            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="storesize" method="POST"
                        action="<?php echo e(route('admin.products.sizes.store', $product->id)); ?>">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        <select name="sizes[]" multiple class="form-select">
                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($size->id); ?>" <?php if(in_array($size->id,$productsizes)): echo 'selected'; endif; ?>><?php echo e($size->value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </form>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\clothesEcommerce\resources\views/admin/products/sizes.blade.php ENDPATH**/ ?>